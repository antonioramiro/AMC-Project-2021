...
public class ChowLiu {
	...
	public double WeightSetter (Dataset T, int i, int j) { //recebe um dataset e calcula a frequencia de cada fibra, assumindo que todos os nï¿½s estï¿½o ligados 
	...
	public Tree MaximalTree (ArrayList<ArrayList<Integer>> edge_list) {
		Tree maximalTree = new Tree(this.dim_measurement); //ï¿½rvore final que vamos devolver
